...
@section('content')
    <div class="roles-permissions">
        ...
        <thead>
            ...
            <td class="w-3/12 px-4 py-3">Email</td>
            <td class="w-2/12 px-4 py-3">Subject Code</td>
            <td class="w-2/12 px-4 py-3">Phone</td>
            ...
            <td> {{ $teacher->user->name }}</td> 
                    ...
                    <td   class=" flex items-center justify-center px-3 "> 
